 ...
 * {@link remixlab.dandelion.core.ReferenceFrame#setConstraint(Constraint)} to associate a
 * Constraint to a Frame (default is a {@code null}
 * {@link remixlab.dandelion.core.ReferenceFrame#constraint()}.
 */
public abstract class Constraint {
	 ...
	 * constraint. Use its {@link remixlab.dandelion.core.ReferenceFrame#position()} and update
	 * the translation accordingly instead.
	 * <p>
	 * {@code translation} is expressed in the local Frame coordinate system. Use
	 * {@link remixlab.dandelion.core.ReferenceFrame#inverseTransformOf(Vec)} to express it
	 ...
	 * constraint. See {@link #constrainTranslation(Vec, ReferenceFrame)} for details.
	 * <p>
	 * Use {@link remixlab.dandelion.core.ReferenceFrame#inverseTransformOf(Vec)} on the
	 ...
	 */	
	public Vec constrainScaling(Vec scaling, ReferenceFrame frame) {
