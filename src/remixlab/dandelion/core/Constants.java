...
public interface Constants extends EventConstants {	
  ...
  public enum DandelionAction {
    ...
    ARP_FROM_PIXEL("Set the arcball reference point from the pixel under the mouse", true, 0),
  	...
  	EDIT_VIEWPORT_PATH("Toggles the key frame camera paths (if any) for edition", true, 0),
    ...
    //CAMERA KEYBOARD ACTIONs  // TODO all of these could be dof_1
  	MOVE_VIEWPORT_LEFT("Move camera to the left", true, 0),
  	MOVE_VIEWPORT_RIGHT("Move camera to the right", true, 0),
  	MOVE_VIEWPORT_UP("Move camera up", true, 0),
  	MOVE_VIEWPORT_DOWN("Move camera down", true, 0),
  ...
  public enum ClickAction implements Actionable<DandelionAction> {
    ...
    ARP_FROM_PIXEL(DandelionAction.ARP_FROM_PIXEL),
  	...
  	EDIT_VIEWPORT_PATH(DandelionAction.EDIT_VIEWPORT_PATH),
    ...
    //CAMERA KEYBOARD ACTIONs
  	MOVE_VIEWPORT_LEFT(DandelionAction.MOVE_VIEWPORT_LEFT),
  	MOVE_VIEWPORT_RIGHT(DandelionAction.MOVE_VIEWPORT_RIGHT),
  	MOVE_VIEWPORT_UP(DandelionAction.MOVE_VIEWPORT_UP),
  	MOVE_VIEWPORT_DOWN(DandelionAction.MOVE_VIEWPORT_DOWN),
