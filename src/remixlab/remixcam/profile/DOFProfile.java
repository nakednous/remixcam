...
public abstract class DOFProfile<A extends Constants.Actionable> extends AbstractProfile<ButtonShortcut> {
	public DOFProfile(AbstractScene scn, String n) {
		super(scn, n);
	}
	 ...
	 * @param button
	 */
	public DLAction binding(Integer button) {
