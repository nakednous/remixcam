...
public abstract class AxisPlaneConstraint extends Constraint {
	 ...
	 * <p>
	 * Use {@link remixlab.remixcam.geom.GeomFrame#setPosition(Vector3D)} to define the
	 ...
	 * <p>
	 * Use {@link remixlab.remixcam.geom.GeomFrame#setOrientation(Quaternion)} to define
