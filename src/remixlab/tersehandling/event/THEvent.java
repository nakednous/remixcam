...
public class THEvent implements EventConstants, Copyable {
	//TODO fix modifiers!
	@Override
	public int hashCode() {
  ...
  public THEvent(Integer modifiers) {
    this.modifiers = modifiers;
    //this.action = null;
    timestamp = System.currentTimeMillis();
  }  
  
  protected THEvent(THEvent other) {
